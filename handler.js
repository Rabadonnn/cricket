...
function loadGoogleFont() {
    ...
    link.href = "https://fonts.googleapis.com/css?family=" + config.preGameScreen.fontFamily.replace(" ", "+");
    link.rel = "stylesheet";
...
let screenManager = ReactDOM.render(React.createElement(ScreenManager, {}), document.getElementById("screens"));
